...
QEMU=env -u SNAP_LIBRARY_PATH qemu-system-i386
...
Ball Paddle Brick Breakout BreakoutInput
...
run_gui: $(KERNEL_OBJ)
	$(QEMU) -device VGA,vgamem_mb=16 -net nic,model=ne2k_isa -net user,tftp=./build/boot -cdrom ./build/boot/grub.iso -monitor stdio
